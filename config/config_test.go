	...
	Convey("Given an environment with no environment variables set", t, func() {
		...
		Convey("When the config values are retrieved", func() {
			...
			Convey("Then the values should be set to the expected defaults", func() {
				...
				So(cfg.Deprecation.EndpointDeprecation, ShouldBeFalse)
				So(cfg.Deprecation.SunsetDate, ShouldEqual, "")
				So(cfg.Deprecation.SunsetLink, ShouldEqual, "")
				So(cfg.Deprecation.DeprecationDate, ShouldEqual, "")
				So(cfg.Deprecation.DeprecationMessage, ShouldEqual, "")
